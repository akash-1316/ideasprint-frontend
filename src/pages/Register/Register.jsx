...
const Register = () => {
  ...
  const handleSubmit = async () => {
    if (!teamName || !leaderName || !leaderEmail || !leaderMobile || !college || !domain) {
  ...
  return (
    <div className="auth-page">
      <div className="event-container">
        ...
        <input placeholder="Team Lead Name" value={leaderName}
          onChange={(e) => setLeaderName(e.target.value)} />

        <input placeholder="Lead Email" value={leaderEmail}
          onChange={(e) => setLeaderEmail(e.target.value)} />

        <input placeholder="Lead Mobile Number" value={leaderMobile}
          onChange={(e) => setLeaderMobile(e.target.value)} />

        <input placeholder="College Name" value={college}
        ...
        {members.map((m, i) => (
          <input key={i} placeholder={`Member ${i + 2} Name`}
            value={m}
